System.register(["./local.sorter", "./local.filter", "./local.pager", "../data-source", "../../helpers"], function (exports_1, context_1) {
    "use strict";
    ...
    var local_sorter_1, local_filter_1, local_pager_1, data_source_1, helpers_1, LocalDataSource;
    return {
        setters: [
            function (local_sorter_1_1) {
                local_sorter_1 = local_sorter_1_1;
            },
            function (local_filter_1_1) {
                local_filter_1 = local_filter_1_1;
            },
            function (local_pager_1_1) {
                local_pager_1 = local_pager_1_1;
            },
        ...
        execute: function () {
            ...
            exports_1("LocalDataSource", LocalDataSource);
        }
    };
});
