System.register(["@angular/core", "./modalInstance.component"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, modalInstance_component_1, ModalComponent, ModalSize;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
            ...
            function (modalInstance_component_1_1) {
                modalInstance_component_1 = modalInstance_component_1_1;
            }
        ],
        execute: function () {
            ModalComponent = (function () {
                function ModalComponent(element) {
                    ...
                    this.instance = new modalInstance_component_1.ModalInstance(this.element);
                    this.instance.hidden.subscribe(function (result) {
                        _this.visible = _this.instance.visible;
                        if (result === modalInstance_component_1.ModalResult.Dismiss) {
...
//# sourceMappingURL=modalmain.component.js.map