System.register(["@angular/core", "@angular/http", "./Global.services", "rxjs/Observable"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, Global_services_1, Observable_1;
    var EmisorService;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            EmisorService = (function () {
                ...
                EmisorService.prototype.ObtenerEstaciones = function () {
                    ...
                    return this._http.get(this._globalService.ApiUrl() + "/Estacion", options)
...
//# sourceMappingURL=Emisor.services.1.js.map